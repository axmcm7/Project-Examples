...
(define x (begin (display 7) (newline) (+ 2 7)))
; expect x
...
(let ((x 90)
           (y (* x 20)))  ; x refers to the global value of x, not 42
       (list x y))
; expect (90 180)
...
(define (enumerate s)
  ; BEGIN PROBLEM 17
  (define (indexing index s)
     (if (null? s) nil
     (cons (list index (car s)) (indexing (+ 1 index) (cdr s)))))
 (indexing 0 s))
  ; END PROBLEM 17
...
(enumerate '(9 10 11 12))
; expect ((0 9) (1 10) (2 11) (3 12))

(enumerate '())
; expect ()

(cons-all 0 '((2 3) (2 7) (3 9)))
; expect ((0 2 3) (0 2 7) (0 3 9))

(let-to-lambda '(let ((m 0) (n 5)) (+ m n)))
; expect ((lambda (m n) (+ m n)) 0 5)

(let-to-lambda '(let ((m 0)) (let ((n m)) n)))
; expect ((lambda (m) ((lambda (n) n) m)) 0)

(zip '((99 88) (77 66) (55 44)))
; expect ((99 77 55) (88 66 44))
